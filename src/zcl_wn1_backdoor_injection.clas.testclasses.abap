...
CLASS ltc_get_amount_in_coins DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    DATA m_cut TYPE REF TO ZCL_WN1_BACKDOOR_INJECTION.
...
CLASS ltc_get_amount_in_coins IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    TEST-INJECTION cash_provider_creation.
      cash_provider = CAST ZIF_WN1_CASH_PROVIDER( NEW ltd_cash_provider_double( ) ).
    END-TEST-INJECTION.
  ENDMETHOD.
