class ZCL_WN1_ROMAN_CONVERTER definition
  public
  final
  create public .
...
CLASS ZCL_WN1_ROMAN_CONVERTER IMPLEMENTATION.


  METHOD to_arabic.
    DATA:
      offset              TYPE i,
      current_digit       TYPE c,
      previous_digit      TYPE c,
      roman               TYPE string,
