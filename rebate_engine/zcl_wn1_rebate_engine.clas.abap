class ZCL_WN1_REBATE_ENGINE definition
  public
  final
  create public .
...
public section.
  ...
  types:
    tt_rules TYPE STANDARD TABLE OF REF TO ZCL_WN1_RULE_ITEM_BASE WITH DEFAULT KEY .
...
CLASS ZCL_WN1_REBATE_ENGINE IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    ELSE.
      ...
      m_rules = VALUE #( ( NEW ZCL_WN1_RULE_ITEM_ID( i_item_id = 1  i_req_quantity = 2  i_rebate = 5 ) ) ).
    ENDIF.
  ENDMETHOD.
