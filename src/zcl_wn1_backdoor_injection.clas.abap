class ZCL_WN1_BACKDOOR_INJECTION definition
  public
  final
  create public .
...
CLASS ZCL_WN1_BACKDOOR_INJECTION IMPLEMENTATION.


  METHOD get_amount_in_coins.
    TEST-SEAM cash_provider_creation.
      DATA(cash_provider) = CAST ZIF_WN1_CASH_PROVIDER( NEW ZCL_WN1_CASH_PROVIDER( ) ).
    END-TEST-SEAM.
