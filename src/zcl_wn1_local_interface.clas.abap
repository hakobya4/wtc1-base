class ZCL_WN1_LOCAL_INTERFACE definition
  public
  final
  create public .
...
CLASS ZCL_WN1_LOCAL_INTERFACE IMPLEMENTATION.


  METHOD get_amount_in_coins.
    TEST-SEAM cash_provider_creation.
      DATA(cash_provider) = CAST lif_cash_provider( NEW lcl_cash_provider_adapter( ) ).
    END-TEST-SEAM.
