class ZCL_WN1_DEPEND_LOOKUP definition
  public
  final
  create public .
...
CLASS ZCL_WN1_DEPEND_LOOKUP IMPLEMENTATION.


  METHOD get_amount_in_coins.
    DATA(cash_provider) = CAST ZIF_WN1_CASH_PROVIDER( NEW ZCL_WN1_CASH_PROVIDER_MANAGED( ) ).
